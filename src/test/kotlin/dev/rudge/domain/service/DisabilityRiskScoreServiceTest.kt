...
internal class DisabilityRiskScoreServiceTest {
    ...
    fun `given an user information with the house mortgaged and risk answers when calculate risk score should add 1 risk points and return score expected`() =
        listOf(
            ...
            dynamicTest("given an user information with the house mortgaged and risk answers $answers when calculate risk score should add 1 risk points and return $score") {
                val userInformation =
    ...
    fun `given an user information with married status and risk answers when calculate risk score should deduct 1 risk points and return score expected`() =
        listOf(
            listOf(false, false, false) to InsuranceScore.ECONOMIC,
            listOf(false, false, true) to InsuranceScore.ECONOMIC,
            listOf(true, false, true) to InsuranceScore.REGULAR,
            listOf(true, true, true) to InsuranceScore.REGULAR
        ).map { (answers, score) ->
